...
writeas user2 /file1.txt succeed
readas user2 /file2.txt succeed
writeas user2 /file2.txt succeed
readas user2 /dev/dv0 succeed
writeas user2 /dev/dv0 succeed
readas user2 /temp/tp2 succeed
writeas user2 /temp/tp2 succeed
readas user2 /boot/config.txt succeed
writeas user2 /boot/config.txt succeed



readas user3 /file1.txt succeed
writeas user3 /file1.txt succeed
readas user3 /file2.txt succeed
writeas user3 /file2.txt succeed
readas user3 /dev/dv0 succeed
writeas user3 /dev/dv0 succeed
readas user3 /temp/tp2 succeed
writeas user3 /temp/tp2 succeed
readas user3 /boot/config.txt succeed
writeas user3 /boot/config.txt succeed
